    ...
    <footer style={{ backgroundColor: '#222222' }}>
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl lg:text-4xl font-bold mb-6 text-white font-sofia">
            Ready to make diet tracking simple and effective?
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto text-gray-300 font-sofia">
        ...
        <div className="border-t pt-12" style={{ borderColor: '#444444' }}>
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                />
                <h3 className="text-2xl font-bold text-white font-sofia">
                  Calio by Vitl
                </h3>
              </div>
              <p className="text-gray-300 mb-4 font-sofia">
              ...
              <div className="flex gap-4">
                <Button size="sm" variant="ghost" className="p-2 hover:bg-gray-600 text-gray-300">
            ...
            <div>
              <h4 className="font-semibold mb-4 text-white font-sofia">Product</h4>
              <ul className="space-y-2 text-gray-300 font-sofia">
            ...
            <div>
              <h4 className="font-semibold mb-4 text-white font-sofia">Company</h4>
              <ul className="space-y-2 text-gray-300 font-sofia">
          ...
          <div className="border-t pt-8" style={{ borderColor: '#444444' }}>
            <div className="rounded-lg p-6 mb-8" style={{ backgroundColor: '#333333' }}>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold mb-2 text-white font-sofia">🛡 Disclaimer</h4>
                  <p className="text-gray-300 text-sm leading-relaxed font-sofia">
